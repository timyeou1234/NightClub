...
class PartyTableViewController: UIViewController, IndicatorInfoProvider{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let destinationController = segue.destination as? PartyDetailViewController{
...
extension PartyTableViewController: UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate{
...
extension PartyTableViewController{
    
    func getData(){
        WebConfig.Manager.request("\(WebConfig.webUrl)newslist", method: .post, parameters: [:], encoding: URLEncoding.default, headers: WebConfig.headers).response { response in
